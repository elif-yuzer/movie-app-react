...
const Main = () => {
  const {setEnteredFilm,handleSubmit,enteredFilm,getData,url}=useContext(MovieContext)
    ...
    <div className="min-h-screen bg-gray-900 flex flex-col gap-3 ">
      <div className="flex justify-center items-center">
        <div className=" flex flex-row justify-center py-4">
          ...
          <form className="flex-row justify-center flex gap-2" onSubmit={handleSubmit}>
            <input
              type="text"
